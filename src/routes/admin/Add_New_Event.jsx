...
import { add_new_event, add_new_movie } from "../../API/API_Calls";
...
const Add_New_Event = () => {
  ...
  const [event_name, set_event_name] = React.useState("");
  ...
  const handleAdd = async () => {
    ...
    try {
      const response = await add_new_event(event_data, token);
